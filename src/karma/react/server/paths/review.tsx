...
export function Calculator() {
  ...
  return (
    <form name="calculator" action="/review#action-section" method="post">
      {result ? (
        <script
      ...
      <div className="flex flex-col">
        ...
        <label className={FORM_GROUP_CLASS}>
          <span className="text-gray-700">Vibes</span>
          <input
              className={FORM_CLASS}
              type="text"
              name="vibes"
              placeholder="Vibes"
              defaultValue={body?.vibes}
          />
        </label>
        <label className={FORM_GROUP_CLASS}>
      ...
      <hr className="my-8" />
      <p>
        By submitting this review I give consent for the above information to be stored, used in community metrics,
        and be used for any purpose that the results are intended for, including but not limited to public publishing
        of the information.
      </p>
      <ReviewConsent />
      <hr className="my-8" />
