...
export function Login() {
    ...
    return (
        <form name="login-authsignal" action="/api/authentication/authsignal/redirect" method="post">
            <div className="flex flex-col">
                <label className={FORM_GROUP_CLASS}>
                    <span className="text-gray-700">Email Address</span>
                    <input className={FORM_CLASS} type="email" name="email" placeholder="Email Address" />
                </label>
            </div>
