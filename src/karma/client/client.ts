...
import { Client as ClientInterface, ClientOptions } from "./client.interface";
import { ok } from "../../is";
...
export class Client implements ClientInterface {
  ...
  async listSystemLogs(): Promise<SystemLog[]> {
    const { baseUrl, headers, prefix, partnerId } = this;
    const url = new URL(`${prefix}/system-logs`, baseUrl);
    if (partnerId) {
