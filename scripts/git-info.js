...
export const minutesBetweenCommitAndBuildValue =
  secondsBetweenCommitAndBuildValue / 60;
export const secondsBetweenCommitAndBuild = toNumberRoundedString(
  secondsBetweenCommitAndBuildValue
);
export const minutesBetweenCommitAndBuild = toNumberRoundedString(
  minutesBetweenCommitAndBuildValue
);

export const minutesFloored = Math.floor(minutesBetweenCommitAndBuildValue);
export const secondsWithoutMinutes = Math.floor(
  secondsBetweenCommitAndBuildValue - minutesFloored * 60
);
export const secondsTime =
  secondsWithoutMinutes > 1 ? ` and ${secondsWithoutMinutes} seconds` : "";
